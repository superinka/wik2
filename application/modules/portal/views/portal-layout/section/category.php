...
<div class="row">
    ...
    <!--breadcrumbs end-->
    <h1 class="page-title">Danh mục: <?php echo $info_category[0]->name ?></h1>
    <p class="page-subtitle">Hiển thị tất cả bài viết của danh mục <i><?php echo $info_category[0]->name ?></i></p>
    </div>
</div>
<div class="line"></div>
<div class="row">
