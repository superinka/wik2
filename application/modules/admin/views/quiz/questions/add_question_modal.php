        ...
        <div class="col-xs-12">
            ...
            <?php echo validation_errors(); ?>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                    <input type="text" id="question_name" value=""name="question_name" required="required" class="form-control col-md-7 col-xs-12">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <textarea id="title" name="title" class="autosize-transition form-control"></textarea>
                    </div>
                </div>
                <div class="form-group">
...
<script>
    ...
    $('#register-btn').click(function(){
        ...
        $.ajax({
            type : "POST",
            dataType : "JSON",
            url: "<?php echo base_url(); ?>" + "admin/quizs/question_add",
            data : {
