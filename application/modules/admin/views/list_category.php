...
<h3 class="header blue lighter smaller">
    ...
    <a href="<?php echo base_url('admin/categories/add') ?>">
        ...
        <?php if ($message){$this->load->view('admin-layout/message',$this->data_layout); }?>
    </a>
</h3>
    <div class="col-xs-12">
        <table id="simple-table" class="table  table-bordered table-hover">
            ...
            <?php $cate_parent_name = $this->CI->get_category_name_by_id($value->Parent_Cate); ?>
                <tr>
                    <td class="center">
                        <label class="pos-rel">
                            <input type="checkbox" class="ace" />
                    ...
                    <td>
                        <a href="#"><?php echo $value->Cate_Name; ?></a>
                    </td>
                    ...
                    <td>
                        <div class="hidden-sm hidden-xs btn-group">
                            ...
                            <button class="btn btn-xs btn-info">
                                <a class="openModal" data-toggle="modal" data-target="#myModal" slug="<?php echo $value->Slug ?>" data-id="<?php echo $value->Cate_ID?>" href="#">
                                    <i class="ace-icon fa fa-pencil bigger-120"></i>
                                </a>
                            </button>

                            <button class="btn btn-xs btn-danger">
                                <a id="delete_category" data-id="<?php echo $value->Cate_ID?>" href="#">
